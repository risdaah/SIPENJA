...
// Filter by tanggal: GET /transaksi/filter?startDate=2026-01-01&endDate=2026-01-31&jenis=SERVIS (jenis opsional)
router.get('/filter', getTransaksiByDateRange);

// Filter by bulan: GET /transaksi/filter-bulan?bulan=1&tahun=2026&jenis=PEMBELIAN (jenis opsional)
